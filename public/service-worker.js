...
class E {
  constructor(e) {
    (this.m = l(e)), (this.N = new Map()), (this.j = new Map()), (this.D = new Map());
  }
  addToCacheList(e) {
    const s = [];
    for (const n of e) {
      ...
      if ((this.N.set(i, e), this.j.set(i, a), s.length > 0)) {
...
self.addEventListener('install', () => self.skipWaiting()),
  ...
  (function (e) {
    T().addToCacheList(e),
      e.length > 0 && (self.addEventListener('install', C), self.addEventListener('activate', S));
  })([
    {
      url: '_next/static/DaJc15uX-Ak6Uhlb2LXql/_buildManifest.js',
      revision: '9e147bab73b89b1a698b5eeb942463da',
    },
    {
      url: '_next/static/DaJc15uX-Ak6Uhlb2LXql/_ssgManifest.js',
      revision: 'abee47769bf307639ace4945f9cfd4ff',
    },
    {
      url: '_next/static/DaJc15uX-Ak6Uhlb2LXql/pages/_app.js',
      revision: '5b0d1d5721dddfa031a12278619e568f',
    },
    {
      url: '_next/static/DaJc15uX-Ak6Uhlb2LXql/pages/_error.js',
      revision: 'c8513510a427404b5c30a842a791d452',
    },
    {
      url: '_next/static/DaJc15uX-Ak6Uhlb2LXql/pages/home.js',
      revision: 'd6d02fc43f062e709ce5ad4ac1615671',
    },
    {
      url: '_next/static/DaJc15uX-Ak6Uhlb2LXql/pages/index.js',
      revision: '513a503b2a7498fce02e5bcd66a263d7',
    },
    {
      url: '_next/static/DaJc15uX-Ak6Uhlb2LXql/pages/map.js',
    ...
    {
      url: '_next/static/chunks/4eaacfe20c46fd4570736bd65650bd3f0f7d19ba.3e8a296b1b5a9153e62e.js',
      revision: '56e7af99250e069c628e50f3c39d59b0',
    },
    {
      url: '_next/static/chunks/87261cfc223b6ab895f948d09ebdb8a3e488f99a.966d61492e1e85f981a5.js',
  ...
  (function (e, s, a) {
    ...
    new (class {
      ...
      async handle({ event: e, request: s }) {
        ...
        const r = this.X({ timeoutId: a, request: s, event: e, logs: n });
        i.push(r);
      ...
      async X({ timeoutId: e, request: t, logs: s, event: n }) {
        let i, a;
        try {
      ...
      plugins: [
        new (class {
          ...
          I(e) {
            ...
            let s = this.W.get(e);
            return s || ((s = new b(e, this.J)), this.W.set(e, s)), s;
          }
          S(e) {
            if (!this.L) return !0;
            const t = this.B(e);
